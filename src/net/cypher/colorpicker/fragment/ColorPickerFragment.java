...
package net.cypher.colorpicker.fragment;
...
import net.cypher.colorpicker.preference.ColorPickerPreference;
import net.cypher.colorpicker.widget.ApplyColorView;
import net.cypher.colorpicker.widget.ColorPickerView;
import net.cypher.colorpicker.widget.ColorViewButton;
import net.cypher.colorpicker.util.ColorPickerHelper;
...
public class ColorPickerFragment extends Fragment implements
    ...
    private static final int PALETTE_AOSIP  = 0;
    ...
    private void setUpPaletteColorButtons() {
        ...
        TypedArray colors = mResources.obtainTypedArray(R.array.color_picker_aosip_palette);
